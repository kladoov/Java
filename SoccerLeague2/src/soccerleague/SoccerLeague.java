...
public static int muestraMenu() {
    ...
    System.out.println("4. MUESTRA ARBITRAJE");
    System.out.println("5. MUESTRA CIUDAD PARTIDO");
    System.out.println("6. EMPEZAR LIGA");
...
try {
    ...
    lga.importarArbitrajes();
    lga.importarCiudadPartido();
...
switch (opt) {
    case 1 -> eqp.visualizaJugador();
    case 2 -> eqp.visualizarEquipos();
    case 3 -> eqp.visualizaFichajes();
    case 4 -> lga.visualizarArbitraje();
    case 5 -> lga.visualizarCiudadPartido();
    case 6 -> {
        //CUARTOS
    ...
    case 7 -> System.out.println("HAS CERRADO LA LIGA ELIMINATORIA");
        default -> System.out.println("INTRODUCE NUMEROS ENTRE EL 1-5!");
        }   
}
  ...
  catch (NumeroImparEquiposExcepcion e3) {
