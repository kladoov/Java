...
public String setNombreJugador(String n) {return this.nombre = n;}
public int setEdadJugador(int e) {return this.edad = e;}
public String setNacionalidadJugador(String na) {return this.nacionalidad = na;}



@Override
public String toString () {
    String text = "\nJugador " + nombre + ", edad " + edad + " con nacionalidad " + nacionalidad + ".";
    return text;
}
